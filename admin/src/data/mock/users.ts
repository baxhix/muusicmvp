  ...
  [
    ...
    },
    {
      base: {
        ...
        age: 24, birthDate: null, sex: 'F' as UserSex,
    ...
    },
    {
      base: {
        ...
        age: 19, birthDate: null, sex: 'M' as UserSex,
    ...
    },
    {
      base: {
        ...
        age: 31, birthDate: null, sex: 'F' as UserSex,
    ...
    },
    {
      base: {
        ...
        age: 22, birthDate: null, sex: 'M' as UserSex,
    ...
    },
    {
      base: {
        ...
        age: 29, birthDate: null, sex: 'F' as UserSex,
    ...
    },
    {
      base: {
        ...
        age: 18, birthDate: null, sex: 'M' as UserSex,
    ...
    },
    {
      base: {
        ...
        role: 'fan' as UserRole, status: 'active' as UserStatus, plan: 'plus' as UserPlan,
        age: 26, birthDate: null, sex: 'F' as UserSex,
    ...
    },
    {
      base: {
        ...
        age: 21, birthDate: null, sex: 'M' as UserSex,
    ...
    },
    {
      base: {
        ...
        role: 'fan' as UserRole, status: 'active' as UserStatus, plan: 'free' as UserPlan,
        age: 17, birthDate: null, sex: 'F' as UserSex,
    ...
    },
    {
      base: {
        ...
        role: 'fan' as UserRole, status: 'active' as UserStatus, plan: 'plus' as UserPlan,
        age: 25, birthDate: null, sex: 'M' as UserSex,
    ...
    },
    {
      base: {
        ...
        role: 'fan' as UserRole, status: 'active' as UserStatus, plan: 'superfan' as UserPlan,
        age: 33, birthDate: null, sex: 'F' as UserSex,
    ...
    },
    {
      base: {
        ...
        role: 'fan' as UserRole, status: 'active' as UserStatus, plan: 'free' as UserPlan,
        age: 16, birthDate: null, sex: 'M' as UserSex,
    ...
    },
    {
      base: {
        ...
        age: 28, birthDate: null, sex: 'F' as UserSex,
        city: 'Belém', state: 'PA',
    ...
    },
    {
      base: {
        ...
        role: 'fan' as UserRole, status: 'active' as UserStatus, plan: 'plus' as UserPlan,
        age: 23, birthDate: null, sex: 'M' as UserSex,
    ...
    },
    {
      base: {
        ...
        age: 14, birthDate: null, sex: 'F' as UserSex,
        city: 'Natal', state: 'RN',
...
function generateExtraUsers(targetTotal: number): User[] {
  ...
  for (let i = 0; i < need; i++) {
    ...
    /* Sintetiza birthDate plausível a partir da idade — useful pra
     * mock parecer realista quando o backend não tiver dados ainda
     * (filter de "data de nascimento" tem valores não-null pra testar). */
    const birthYear = new Date().getFullYear() - age;
    const birthMonth = String((Math.floor(r() * 12) + 1)).padStart(2, '0');
    const birthDay = String((Math.floor(r() * 27) + 1)).padStart(2, '0');
